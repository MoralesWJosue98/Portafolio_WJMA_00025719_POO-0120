...
namespace PREPARCIAL2
{
    public partial class frmPrincipal : Form
    {
        ...
        CProxy.IList miProxy = new CProxy.ProxyList();
        CProxy.ICreateProduct miProxy2 = new CProxy.ProxyCProduct();
        CProxy.IModifyStock miProxy3 = new CProxy.ProxyStock();
        CProxy.IDeleteProduct miProxy4 = new CProxy.ProxyDelete();
        ...
        {
            List<Inventory> list = miProxy.getList() ;
            ...
            cmbDeleteProduct.DataSource = null;
            cmbDeleteProduct.ValueMember = "product_name";
            cmbDeleteProduct.DisplayMember = "id_product";
            cmbDeleteProduct.DataSource = list;

            cmbBuyProduct.DataSource = null;
            cmbBuyProduct.ValueMember = "id_product";
            cmbBuyProduct.DisplayMember = "product_name";
            cmbBuyProduct.DataSource = list;
            
            cmbBuyId.DataSource = null;
            cmbBuyId.ValueMember = "product_name";
            cmbBuyId.DisplayMember = "id_product";
            cmbBuyId.DataSource = list;
        ...
        private void btnCreateProduct_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    miProxy2.CProduct(txtProduct.Text, txtDescription.Text, Convert.ToDouble(txtPrice.Text),Convert.ToInt32(txtStock.Text));
        ...
        private void btnApplyStock_Click(object sender, EventArgs e)
        {
            ...
            { 
                miProxy3.MStock(Convert.ToInt32(txtNewStock.Text), cmbProduct.Text);
       ...
       private void btnDeleteProduct_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Estas seguro de querer eliminar el producto " + cmbDeleteProduct.ValueMember + " ?",
                "DISTRIBUIDORA 'LA SULTANA'", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                miProxy4.DProduct(Convert.ToInt32(cmbDeleteProduct.Text));
        ...
        private void btnBuy_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    OrderDAO.Buy(user.user_name, cmbBuyProduct.Text, Convert.ToInt32(nudQuantity.Value),user.id_user, Convert.ToInt32(cmbBuyId.Text));
        ...
        private void poblarGrafico()
        {
            ...
            foreach (Inventory i in miProxy.getList())
            {
